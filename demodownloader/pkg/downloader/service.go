...
func New(httpClient api_client.HttpClient) *DownloaderService {
...
func (s *DownloaderService) DownloadDemo(url string, demoDir string, lastModified time.Time) error {
	// Validate the url
